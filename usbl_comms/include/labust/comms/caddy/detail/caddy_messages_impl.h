  void BuddyReport::pack(boost::archive::binary_oarchive& out) const
{
  ...
  if ((inited == 1)){
  st.put(course,-180,179.296875,9);
  }
  if ((inited == 1)){
  st.put(speed,0,1,4);
  }
  ...
  st.put(lawn_width,1,8,3);
  }
  if ((inited == 1) && (command == 1)){
  st.put(lawn_length,1,8,3);
  }
  ...
  void BuddyReport::unpack(boost::archive::binary_iarchive& in) 
{
  ...
  if ((inited == 1)){
  st.get(course,-180,179.296875,9);
  }
  if ((inited == 1)){
  st.get(speed,0,1,4);
  }
  ...
  if ((inited == 1) && (command == 1)){
  st.get(lawn_width,1,8,3);
  }
  if ((inited == 1) && (command == 1)){
  st.get(lawn_length,1,8,3);
  }
...
{
    labust::tools::BitStorage st;
  st.put(heading,-180,179.296875,9);
  st.put(depth,0,63.5,7);
  st.put(avg_flipper_rate,0,3,4);
  ...
  void DiverReport::unpack(boost::archive::binary_iarchive& in) 
{
  ...
  labust::tools::BitStorage st(data);
  st.get(heading,-180,179.296875,9);
  st.get(depth,0,63.5,7);
  st.get(avg_flipper_rate,0,3,4);
